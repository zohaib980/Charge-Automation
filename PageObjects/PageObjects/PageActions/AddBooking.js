...
export class bookingPageElements{
    ...
    happyAddBooking(chooseProperty){
        ...
        cy.get(bookingElementLocators.BookingPageLocators.date_picker).type('{enter}').wait(3000)
        ...
        cy.get(bookingElementLocators.BookingPageLocators.select_nationality).select("Pakistani").wait(2000)
